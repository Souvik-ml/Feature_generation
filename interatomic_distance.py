...
directory = '/home/souvik/MXene/files/car_O'  # Replace with your directory path
...
for filename in os.listdir(directory):
    ...
    if os.path.isfile(poscar_path):
        ...
        for i in range(len(sorted_positions) - 1):
            row1 = sorted_positions[i]
            row2 = sorted_positions[i + 1]
...
output_df.to_excel('Inter_distance_O.xlsx')
