...
directory = '/home/souvik/MXene/files/car_SCN'  # Replace with your directory path
...
for filename in os.listdir(directory):
    ...
    if os.path.isfile(poscar_path):
        ...
        new_sorted_positions = sorted_positions[2:-2]
        subtracted_data = []
...
output_df.to_excel('Inter_distance_SCN.xlsx')
